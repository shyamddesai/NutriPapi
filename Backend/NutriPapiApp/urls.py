...
from .views import view_meal_logs, view_schedule, schedule_meals, delete_recipes_and_ingredients, list_ingredients, list_recipes, import_recipes_and_ingredients, delete_meal_logs_for_today, caloric_intake_recommendation_view, sign_out_view, change_password, delete_account_view, meal_reminder_view, log_meal_view, get_user_info, remove_ingredients_from_fridge_view, signup_view, signup_follow_view, signin_view, user_info_view, add_ingredients_to_fridge_view, view_fridge_contents_view, search_view
...
urlpatterns = [
    ...
    path('meals/search/', search_view, name='search'),
    ...
    path('recipe/delete', delete_recipes_and_ingredients, name='delete_recipe'),
    path('schedule/view', view_schedule, name='view_schedule'),
    path('schedule/add', schedule_meals, name='schedule_meals'),
    path('schedule/reminder/', meal_reminder_view, name='meal_reminder')
]
