Feature: Account Deletion
  ...
  Scenario: Attempt to Delete Account without Confirmation (Error Flow)
    ...
    Then the system does not delete their account, displaying an error message such as "Account deletion failed. Please confirm to proceed with account deletion."
